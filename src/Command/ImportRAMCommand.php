...
use App\Utils\Utils;
use App\Utils\RAMStorageMethods;
use App\Exceptions\CustomExceptionMessage;
use PhpOffice\PhpSpreadsheet\IOFactory;
use Pimcore\Model\Notification\Service\NotificationService;

class ImportRAMCommand extends Command
{
    protected static $defaultName = 'import:ram';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            RAMStorageMethods::storeRAM($data, $countryCode);
            Utils::sendNotification(
                $this->notificationService,
                $this->sender,
                $this->receiver,
                "From RAM Importer",
                "All RAM data are imported"
            );

            $output->writeln('RAM import completed.');
