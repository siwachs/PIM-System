...
use App\Utils\Utils;
use App\Utils\SSDStorageMethods;
use App\Exceptions\CustomExceptionMessage;
use PhpOffice\PhpSpreadsheet\IOFactory;
use Pimcore\Model\Notification\Service\NotificationService;

class ImportSSDCommand extends Command
{
    protected static $defaultName = 'import:ssd';
    ...
    {
        $this->setDescription('Imports SSD data')
    ...
    {
        $output->writeln('Importing SSD data...');
        ...
        try {
            ...
            SSDStorageMethods::storeSSDs($data, $countryCode);
            ...
            Utils::sendNotification(
                ...
                $this->receiver,
                "From SSD Importer",
                "All SSD data are imported"
            );

            $output->writeln('SSD import completed.');
