...
use App\Utils\Utils;
use App\Utils\MotherboardStorageMethods;
use App\Exceptions\CustomExceptionMessage;
use PhpOffice\PhpSpreadsheet\IOFactory;
use Pimcore\Model\Notification\Service\NotificationService;

class ImportMotherboardsCommand extends Command
{
    protected static $defaultName = 'import:motherboards';
    ...
    {
        $this->setDescription('Imports motherboards data')
    ...
    {
        $output->writeln('Importing motherboards data...');
        ...
        try {
            ...
            MotherboardStorageMethods::storeMotherboards($data, $countryCode);
            Utils::sendNotification(
                $this->notificationService,
                $this->sender,
                $this->receiver,
                "From Motherboards Importer",
                "All motherboards are imported"
            );

            $output->writeln('Motherboards import completed.');
