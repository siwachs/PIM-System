...
{
    /**
     * @Route("/export-products", name="exportProducts", methods={"GET"})
     * @param Request $request
     *
     * @return JsonResponse
     */
    public function exportProducts(Request $request, TokenValidationMiddleware $tokenValidation): JsonResponse
    {
